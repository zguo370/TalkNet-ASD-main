...
def main():
    ...
    parser.add_argument('--maxEpoch',     type=int,   default=10,    help='Maximum number of epochs=25')
    ...
    loader = train_loader(trialFileName = args.trainTrialAVA, \
                          ...
                          **vars(args))
    trainLoader = torch.utils.data.DataLoader(loader, batch_size = 1, shuffle = True, num_workers =0 ) #num_works=args.nDataLoaderThread
    ...
    loader = val_loader(trialFileName = args.evalTrialAVA, \
                        ...
                        **vars(args))
    valLoader = torch.utils.data.DataLoader(loader, batch_size = 1, shuffle = False, num_workers = 0) #num_workers=16
